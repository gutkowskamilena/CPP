...
int main()
{
    std::string fileNameWithPath("C:\\Users\\gutko\\source\\sda\\8.C++ - ZAAWANSOWANY\\Pliki\\Pliki.cpp"); // ca�a �cie�ka do pliku
    ...
    std::string fileNameToWrite("C:\\Users\\gutko\\source\\sda\\8.C++ - ZAAWANSOWANY\\test.txt");
